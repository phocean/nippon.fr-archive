...
var FlashMediaElementRenderer = {
	create: function create(mediaElement, options, mediaFiles) {
		...
		if (_constants.IS_IE || _constants.IS_EDGE) {
			...
			specialIEContainer.outerHTML = '<object ' + settings.js';
		} else {
			...
			flash.flashWrapper.innerHTML = '<embed ' + settings.js';
		}
...
var NativeFlv = {
	...
	load: function load(settings) {
		if (typeof flvjs !== 'undefined') {
			...
			settings.options.path = typeof settings.options.path === 'string' ? settings.options.path : 'https://cdnjs.cloudflare.com/ajax/libs/flv.js';
...
var FlvNativeRenderer = {
	...
	options: {
		prefix: 'native_flv',
		flv: {
			path: 'https://cdnjs.cloudflare.com/ajax/libs/flv.js',
...
var NativeHls = {
	...
	load: function load(settings) {
		if (typeof Hls !== 'undefined') {
			...
			settings.options.path = typeof settings.options.path === 'string' ? settings.options.path : 'https://cdnjs.cloudflare.com/ajax/libs/hls.js';
...
var HlsNativeRenderer = {
	...
	options: {
		prefix: 'native_hls',
		hls: {
			path: 'https://cdnjs.cloudflare.com/ajax/libs/hls.js',
